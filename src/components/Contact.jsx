  ...
  return (
    <section id="contact" className="relative px-5 py-24 md:px-8 md:py-32">
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        <p className="mb-4 font-mono text-xs uppercase tracking-[0.28em] text-series">
          Contact
        </p>
        ...
        <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="text-sm text-muted underline-offset-4 hover:text-vibranium hover:underline"
            >
              Live projects
            </a>
            <SocialLinks />
